...
using Voitures.Client.Pages;
using Voitures.Components;
...
{
    options.UseSqlite("Data Source=voitures.db");
});
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(Voitures.Client._Imports).Assembly);
